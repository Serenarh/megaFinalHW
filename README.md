...
Starter data is copied from [here.](https://jsonplaceholder.typicode.com/users)

This repo is meant to correspond with lessons on working with `Array.prototype`.

This repo uses `mjs` files so that we can use [ES2015 modules.](https://hacks.mozilla.org/2015/08/es6-in-depth-modules/) 

**If you are on Windows, you _must_ [upgrade your Node installation to the _current_ version,](https://nodejs.org/en/) or at least version 13!**
